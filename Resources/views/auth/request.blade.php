...
@section('content')
<!-- Reset form -->
<div class="page-signin-container">
    <h2 class="m-t-0 m-b-4 text-xs-center font-weight-semibold font-size-20">Request password reset</h2>
    <form action="{{route('admin::auth.request')}}" method="post" class="panel p-a-4">
